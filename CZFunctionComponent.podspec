...
# 资源
  s.source       = { :git => "https://github.com/JuYiWei/CZFunctionComponent.git", :tag => "#{s.version}" }


  # s.source_files  = "CZCategory/CZCategory/Category/*.{h,m}"
  s.subspec 'FunctionComponent' do |ss1|
    ss1.source_files  = "CZFunctionComponent/CZFunctionComponent/FunctionComponent/*.{h,m}"
  end
